...
<body>
    ...
    <nav class="navbar navbar-expand bg-dark border-bottom fixed">
        ...
        <!-- </div> -->
            <!-- <div class=card> -->
                ...
                <!-- Button trigger modal -->
                    <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#additem">
                     Add Item
                    </button>
                <!-- </div> -->
            <!-- </div> -->
        ...
        ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success editbtn"><i class="fas fa-pen"></i></button>
